    ...
    public partial class ExamForm : Form
    {
        ...
        private void LoadSubjects()
        {
            ...
            if (subjects.Count > 0)
            {
                ...
                cmdSubject.DisplayMember = "SubjectName"; // What user sees
                cmdSubject.ValueMember = "SubjectId";     // What gets stored
                cmdSubject.SelectedIndex = -1;            // Optional: no preselection
            }
            else
            {
